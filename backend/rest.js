...
app.put('/update-entry/:id', (req, res) => {
    const updatedEntry = new DiaryEntryModel({_id: req.body.id, recipe: req.body.recipe, preptime: req.body.preptime,
        cooktime: req.body.cooktime, cuisine: req.body.cuisine, course: req.body.course,diet: req.body.diet, ingredients: req.body.ingredients})
...
app.post('/add-entry', (req, res, next) => {
    ...
    const diaryEntry = new DiaryEntryModel({recipe: req.body.recipe, preptime: req.body.preptime,cooktime: req.body.cooktime, cuisine: req.body.cuisine, course: req.body.course,diet: req.body.diet, ingredients: req.body.ingredients
      });
    diaryEntry.save()
        .then(() => {
            res.status(200).json({
